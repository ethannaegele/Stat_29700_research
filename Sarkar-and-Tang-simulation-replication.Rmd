...
for (m in 1:50) {
  ...
  vec_equi_mult <- c(vec_equi_mult, condition_number_test_equi_mult(regression$X, multiplier = 1.99))
}
mean(vec_equi)
mean(vec_equi_mult)
...
result_mult <- create_equicorrelated_mult(regression$X, multiplier = 2)
```
