...
set.seed(12)
method1_setting1_v4 <- run_sarkar_tang_method1_setting1_simulation()

set.seed(12)
method1_setting2_v4 <- run_sarkar_tang_method1_setting2_simulation()

set.seed(12)
method1_setting3_v4 <- run_sarkar_tang_method1_setting3_simulation()