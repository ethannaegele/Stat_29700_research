...
```{r}
run_method2_simulation <- function(n, d, a, num_true_sigs, eta = .7, multiplier = 1.9, num_iter = 300){
...
for (m in 1:num_iter){
  ...
  rejected_indices <- sarkar_tang_method2(regression$X, regression$Y, alpha = .05, eta = eta, multiplier = multiplier)
